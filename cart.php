...
*/
// el de abajo lo quite yo, carlos maquera no hay efecto si lo quito.
...
$r = $controlador->verProducto($product_id);
...
<th><?php echo $c['q'];?></th>
	...
	?>
            <a href="proceso/delfromcart.php?id=<?php echo $c["product_id"];?>" class="btn btn-danger">Eliminar</a>
	</td>
</tr>
<?php endforeach; ?>
</table>

<form class="form-horizontal" method="post" action="proceso/process.php">
